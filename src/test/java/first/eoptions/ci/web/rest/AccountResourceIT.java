package first.eoptions.ci.web.rest;

import static first.eoptions.ci.web.rest.AccountResourceIT.TEST_USER_LOGIN;
import static org.assertj.core.api.Assertions.assertThat;
import static org.springframework.test.web.servlet.request.MockMvcRequestBuilders.*;
import static org.springframework.test.web.servlet.result.MockMvcResultMatchers.*;

import first.eoptions.ci.IntegrationTest;
import first.eoptions.ci.config.Constants;
import first.eoptions.ci.domain.User;
import first.eoptions.ci.repository.AuthorityRepository;
import first.eoptions.ci.repository.UserRepository;
import first.eoptions.ci.security.AuthoritiesConstants;
import first.eoptions.ci.service.UserService;
import first.eoptions.ci.service.dto.AdminUserDTO;
import first.eoptions.ci.service.dto.PasswordChangeDTO;
import first.eoptions.ci.service.dto.UserDTO;
import first.eoptions.ci.web.rest.vm.KeyAndPasswordVM;
import first.eoptions.ci.web.rest.vm.ManagedUserVM;
